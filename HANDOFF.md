<!--
  ...
  Внутри встречаются ссылки на `jam-concept-pitch.md` — этот документ
  удалён 2026-05-07 (см. docs/design/DECISIONS.md). Не искать в репе и не
  пытаться восстановить из истории.
  ============================================================================
-->
...
> Ссылки на `jam-concept-pitch.md` внутри — broken; файл удалён, см. DECISIONS 2026-05-07.
