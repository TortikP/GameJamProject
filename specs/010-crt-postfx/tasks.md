...
- [x] T082 [P0] **Early-exit за безелем.** `if (bz >= 1.0) { COLOR = black; return; }`
      сразу после `bezel_mask`. Углы (5–10% фрагментов на скруглённой рамке) теперь
      не делают ни одного текстурного сэмпла.
