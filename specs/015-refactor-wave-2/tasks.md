...
- [ ] A1. `CLAUDE.md` § Hard rules / Architecture — добавить блок «Accepted compromises» после правила 5 (UiTheme).
- [ ] A2. Commit: `docs(015): F-004+F-005 — accepted Actor/HexGrid Node2D compromise`.
